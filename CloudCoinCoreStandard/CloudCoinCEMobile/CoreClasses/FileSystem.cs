...
namespace CloudCoinCEMobile.CoreClasses
{
    class FileSystem : IFileSystem
    {
        ...
        public void CopyTemplates()
        {
            ...
            foreach (String fileName in fileNames)
            {
                if (fileName.Contains("jpeg") || fileName.Contains("jpg"))
                {
                    try
                    {
                        string outputpath =  "Templates" + System.IO.Path.DirectorySeparatorChar + fileName.Substring(26);
        ...
        private bool importJPEG(String fileName)//Move one jpeg to suspect folder. 
        {
            ...
            System.Diagnostics.Debug.WriteLine("Trying to load: " + ImportFolder + fileName);
            try
            {
