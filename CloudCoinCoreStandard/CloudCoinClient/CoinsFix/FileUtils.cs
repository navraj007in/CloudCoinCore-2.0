...
namespace Founders
{
    public class FileUtils
    {
        ...
        public CloudCoinCore.CloudCoin loadOneCloudCoinFromJsonFile(String loadFilePath)
        {

            CloudCoinCore.CloudCoin returnCC = new CloudCoinCore.CloudCoin();
            ...
            try
            {
                 returnCC = JsonConvert.DeserializeObject<CloudCoinCore.CloudCoin>(incomeJson);
        ...
        public CloudCoinCore.CloudCoin loadOneCloudCoinFromJPEGFile(String loadFilePath)
        {
            ...
            CloudCoinCore.CloudCoin returnCC = this.parseJpeg(wholeString);
        ...
        // en d json test
        public String setJSON(CloudCoinCore.CloudCoin cc)
        {
            const string quote = "\"";
            const string tab = "\t";
        ...
        public bool writeJpeg(CloudCoinCore.CloudCoin cc, string tag)
        {
        ...
        public bool writeTo(String folder, CloudCoinCore.CloudCoin cc)
        {
            CoinUtils cu = new CoinUtils(cc);
            const string quote = "\"";
            const string tab = "\t";
        ...
        public void overWrite(String folder, CloudCoinCore.CloudCoin cc)
        {
            CoinUtils cu = new CoinUtils(cc);
            const string quote = "\"";
            const string tab = "\t";
        ...
        private CloudCoinCore.CloudCoin parseJpeg(String wholeString)
        {

            CloudCoinCore.CloudCoin cc = new CloudCoinCore.CloudCoin();
            int startAn = 40;
            for (int i = 0; i < 25; i++)
            {
