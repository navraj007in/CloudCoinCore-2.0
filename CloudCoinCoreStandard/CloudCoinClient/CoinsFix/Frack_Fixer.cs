...
namespace Founders
{
    public class Frack_Fixer
    {
        ...
        public string fixOneGuidCorner(int raida_ID, CloudCoinCore.CloudCoin cc, int corner, int[] trustedTriad)
        {
        ...
        public CoinUtils fixCoin(CloudCoinCore.CloudCoin brokeCoin)
        {
